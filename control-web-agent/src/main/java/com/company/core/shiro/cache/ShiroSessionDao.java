package com.company.core.shiro.cache;
...
import com.company.core.util.JedisUtils;
...
public class ShiroSessionDao extends CachingSessionDAO {
    ...
    public Session readSession(Serializable sessionId) throws UnknownSessionException {
        ...
        if (cached == null
            || cached.getAttribute(DefaultSubjectContext.PRINCIPALS_SESSION_KEY) == null) {
            try {
        ...
        try {
            if (session instanceof ShiroSession) {
                ...
                try {
                    ...
                    logger.info("shiro session id {} 被更新", session.getId(),
                ...
                logger.info("ID {} classname {} 作为非ShiroSession对象被更新, ", session.getId(),
                    session.getClass().getName());
            } else {
