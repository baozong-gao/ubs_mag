...
<div class="bjui-pageContent tableContent">
    <table  class="table table-bordered table-hover table-striped table-top" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <c:forEach var="record" items="${orderListForm.pagination.list}" varStatus="status">
            ...
            <td align="center">
                <a href="${pageContext.request.contextPath}/recomCode/dettailOrder?id=<c:out value="${record.id}"/>&orderId=<c:out value="${record.orderId}"/>&payOrder=<c:out value="${record.payOrder}"/>" class="btn btn-primary" data-toggle="navtab" data-id="tab-detail-order" data-title="订单详细信息">详细</a>
            </td>
            </tr>
        </c:forEach>
        </tbody>
