...
public class BaseFormAuthenticationFilter extends FormAuthenticationFilter {
     ...
     * @return
     * @throws Exception
     * @see org.apache.shiro.web.filter.authc.FormAuthenticationFilter#onLoginSuccess(org.apache.shiro.authc.AuthenticationToken, org.apache.shiro.subject.Subject, ServletRequest, ServletResponse)
     */
    @Override
